...
import {
	useDeleteMessage,
	useMessages,
} from '@/services/queries/messages.query'
...
const MessageList = () => {
	...
	if (isLoading)
		return (
			<div className="col-span-1 flex h-[50vh] items-center justify-center rounded-lg border border-gray-500 shadow-lg">
				<div
					role="status"
					className="just flex items-center justify-center gap-1"
				>
					<svg
						aria-hidden="true"
						className="h-8 w-8 animate-spin fill-blue-600 text-gray-200 dark:text-black"
						viewBox="0 0 100 101"
						fill="none"
